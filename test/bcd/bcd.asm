...
%macro test_bcd 3                       ; bcd_instruction, af_value, test_set
    mov cx, word [cs:%3]
    mov bp, 2
...
%macro bcd_interesting_set 2            ; instruction, af
    %assign cnt_a 8
    %assign cnt_b 8
    dw  cnt_a * cnt_b
...
%macro bcd_generic_set 2                ; instruction, af
    %assign step_a 13
    %assign step_b 11
...
section .text
    ...
    mark 0x60
    test_bcd aaa, 0, aaa_interesting_set_0
    mark 0x61
    test_bcd aaa, 0, aaa_generic_set_0
    mark 0x62
    test_bcd aaa, 1, aaa_interesting_set_1
    mark 0x63
