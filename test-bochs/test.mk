...
TEST_OBJS = $(COMMON_OBJDIR)/main.o $(COMMON_OBJDIR)/binary_header.o $(COMMON_OBJDIR)/bochs_api.o \
	$(COMMON_OBJDIR)/config.o $(COMMON_OBJDIR)/devices.o $(COMMON_OBJDIR)/dump_state.o \
	$(COMMON_OBJDIR)/test_api.o $(VMDIR)/bin/libcpu.a $(VMDIR)/bin/libutil.a $(LIBXIB)
