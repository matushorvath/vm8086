...
BASE_OBJS = vm8086.o arg_al_ax_near_ptr.o arg_mod_op_rm.o arg_mod_reg_rm.o arg_reg.o \
	...
	exec.o flags.o group1.o group2.o group_immed.o in_out.o inc_dec.o instructions.o interrupt.o \
	jump.o load.o location.o memory.o nibbles.o parity.o prefix.o split233.o stack.o state.o \
	transfer.o util.o
