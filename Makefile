...
BASE_OBJS = vm8086.o add_sub_cmp.o arg_al_ax_near_ptr.o arg_mod_op_rm.o arg_mod_reg_rm.o \
	arg_reg.o arg_immediate.o arg_reg_immediate_b.o arg_reg_immediate_w.o bits.o bitwise.o \
	call.o decode.o dump_state.o error.o exec.o flags.o group1.o group2.o group_immed.o in_out.o \
	inc_dec.o instructions.o interrupt.o jump.o jump_flag.o load.o location.o loop.o memory.o \
	nibbles.o parity.o prefix.o split233.o stack.o state.o trace.o trace_data.o \
