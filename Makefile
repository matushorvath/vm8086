...
BASE_OBJS = vm8086.o add.o arithmetic.o arg_al_ax_near_ptr.o arg_mod_op_rm.o arg_mod_reg_rm.o \
	...
	instructions.o interrupt.o jump.o jump_flag.o load.o location.o loop.o memory.o mod9.o \
	mod17.o mul.o nibbles.o parity.o prefix.o rotate_b.o rotate_w.o shift_b.o shift_w.o shl.o \
	shr.o split233.o stack.o state.o sub_cmp.o test_api.o trace.o trace_data.o \
