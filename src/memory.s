...
calc_addr_b_off_hi_done:
    ...
    jnz [rb + tmp], calc_addr_b_addr_hi_done

    add [rb + addr_hi], -0x100000, [rb + addr_hi]

calc_addr_b_addr_hi_done:
    arb 4
    ret 2
.ENDFRAME
