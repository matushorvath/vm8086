...
instructions:
    ...
    db  execute_txa, 0                                      # 8a a = reg_x; updateNegativeZero(reg_a) TODO
    ...
    db  execute_tya, 0                                      # 98 a = reg_y; updateNegativeZero(reg_a) TODO
    db  execute_sta, absolute_y                             # 99
    db  execute_tsx, 0                                      # 9a sp = reg_x TODO
    ...
    db  execute_tay, 0                                      # a8 y = reg_a; updateNegativeZero(reg_y) TODO
    db  execute_lda, immediate                              # a9
    db  execute_tax, 0                                      # aa x = reg_a; updateNegativeZero(reg_x) TODO
    ...
    db  execute_tsx, 0                                      # ba x = sp; updateNegativeZero(reg_x) TODO
    ...
    db  execute_iny, 0                                      # c8 y = inr(reg_y) TODO
    db  execute_cmp, immediate                              # c9
    db  execute_dex, 0                                      # ca x = der(reg_x) TODO
    ...
    db  execute_inx, 0                                      # e8 x = inr(reg_x) TODO
