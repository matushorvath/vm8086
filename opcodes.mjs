export const OPCODES = {
    ...
    0x10: { name: 'BPL', code: 0x10, length: 1 },
    0x30: { name: 'BMI', code: 0x30, length: 1 },
    0x50: { name: 'BVC', code: 0x50, length: 1 },
    0x70: { name: 'BVS', code: 0x70, length: 1 },
    0x90: { name: 'BCC', code: 0x90, length: 1 },
    0xB0: { name: 'BCS', code: 0xB0, length: 1 },
    0xD0: { name: 'BNE', code: 0xD0, length: 1 },
    0xF0: { name: 'BEQ', code: 0xF0, length: 1 },
    ...
    0x18: { name: 'CLC', code: 0x18, length: 1 },
    0x38: { name: 'SEC', code: 0x38, length: 1 },
    0x58: { name: 'CLI', code: 0x58, length: 1 },
    0x78: { name: 'SEI', code: 0x78, length: 1 },
    0xB8: { name: 'CLV', code: 0xB8, length: 1 },
    0xD8: { name: 'CLD', code: 0xD8, length: 1 },
    0xF8: { name: 'SED', code: 0xF8, length: 1 },
    ...
    0xAA: { name: 'TAX', code: 0xAA, length: 1 },
    0x8A: { name: 'TXA', code: 0x8A, length: 1 },
    0xCA: { name: 'DEX', code: 0xCA, length: 1 },
    0xE8: { name: 'INX', code: 0xE8, length: 1 },
    0xA8: { name: 'TAY', code: 0xA8, length: 1 },
    0x98: { name: 'TYA', code: 0x98, length: 1 },
    0x88: { name: 'DEY', code: 0x88, length: 1 },
    0xC8: { name: 'INY', code: 0xC8, length: 1 },
    ...
    0x9A: { name: 'TXS', code: 0x9A, length: 2 },
    0xBA: { name: 'TSX', code: 0xBA, length: 2 },
    0x48: { name: 'PHA', code: 0x48, length: 3 },
    0x68: { name: 'PLA', code: 0x68, length: 4 },
    0x08: { name: 'PHP', code: 0x08, length: 3 },
    0x28: { name: 'PLP', code: 0x28, length: 4 },
